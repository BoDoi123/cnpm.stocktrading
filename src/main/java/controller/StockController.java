...
public class StockController {
    ...
    public List<PersonalStock> getPersonalStock(int userId) {
        return personalStockDAO.getPersonalStockByUserId(userId);
    }
    ...
    public List<StockTransaction> getTransactionHistory(int userId) {
